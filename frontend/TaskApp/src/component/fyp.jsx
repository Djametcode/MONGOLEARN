...
const List = ({ data, refresh }) => {
  ...
  return (
    <div className=" bg-slate-100 flex flex-col p-4 text-sm">
      <div className=" flex justify-start bg-slate-400 mb-2 rounded-lg">
      ...
      <div className=" bg-slate-400 p-3 pb-10 rounded-xl">
